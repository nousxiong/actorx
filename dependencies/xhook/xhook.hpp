...
protected:
  ...
  static XHOOK_IA64_METADATA const* GetRceCopyTable()
  {
    static const XHOOK_IA64_METADATA rceCopyTable[33] =
    {
...
// nousxiong Add inline for all api.
#define XHOOK_FUNC inline
#include "xhook.cpp"
